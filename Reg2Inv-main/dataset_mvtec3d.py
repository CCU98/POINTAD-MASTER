from geotransformer.datasets.registration.mvtec3d.dataset import MVTecPairDataset_train,MVTecPairDataset_test,MVTecDataset_train
...
def train_valid_data_loader(cfg, distributed):
    train_dataset = MVTecPairDataset_train(
    ...
    valid_dataset = MVTecPairDataset_train(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "val",
        voxel_size=cfg.data.voxel_size,
...
def test_data_loader(cfg):
    ...
    test_dataset = MVTecPairDataset_test(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "test",
        voxel_size=cfg.data.voxel_size,
...
def bank_data_loader(cfg):
    ...
    test_dataset = MVTecDataset_train(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "test",
        voxel_size=cfg.data.voxel_size,
