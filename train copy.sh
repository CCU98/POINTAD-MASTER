...
for cls_id in "${!cls_ids[@]}";do
    ...
    for i in "${!depth[@]}";do
        ...
        ## train on the VisA dataset
            ...
            CUDA_VISIBLE_DEVICES=${device} python train.py --dataset mvtec_pc_3d_rgb --train_data_path /data2/ZTT/mvtec_3d_mv \
            --save_path ${save_dir} \
            ...
            --data_path /data2/ZTT/mvtec_3d_mv --save_path ./results/mvtec_${base_dir}_pc_336_4_all/with_color_max_scor${obj_list[cls_id]}/zero_shot_1 \
...
for cls_id in "${!cls_ids[@]}";do
    ...
    for i in "${!depth[@]}";do
        ...
        ## train on the VisA dataset
            ...
            save_dir=./exps_${base_dir}_336_4/${obj_list[cls_id]}/
            CUDA_VISIBLE_DEVICES=${device} python train.py --dataset eye_pc_3d_rgb  --train_data_path /data2/ZTT/Eyecandies_processed \
            --save_path ${save_dir} \
            --features_list 24 --image_size 336  --batch_size 4 --print_freq 1 \
            --epoch 15 --save_freq 1 --depth ${depth[i]} --n_ctx ${n_ctx[j]} --t_n_ctx ${t_n_ctx[0]} --train_dataset_name ${obj_list[cls_id]}
            ...
            --data_path /data2/ZTT/Eyecandies_processed --save_path ./results/mvtec_${base_dir}_pc_336_4_all/with_color_max_scor${obj_list[cls_id]}/zero_shot \
            --checkpoint_path ${save_dir}epoch_15.pth \
            --features_list 24 --image_size 336 --depth ${depth[i]} --n_ctx ${n_ctx[j]} --t_n_ctx ${t_n_ctx[0]} --train_class ${obj_list[cls_id]}
        wait
        done
...
for cls_id in "${!cls_ids[@]}";do
    ...
    for i in "${!depth[@]}";do
        ...
        ## train on the VisA dataset
            ...
            save_dir=./exps_${base_dir}_336_4/${obj_list[cls_id]}/
            CUDA_VISIBLE_DEVICES=${device} python train.py --dataset real_pc_3d_rgb  --train_data_path /data2/ZTT/Real3D-AD \
            --save_path ${save_dir} \
            ...
            --data_path /data2/ZTT/Real3D-AD --save_path ./results/mvtec_${base_dir}_pc_336_4_all/with_color_max_scor${obj_list[cls_id]}/zero_shot \
            --checkpoint_path ${save_dir}epoch_15.pth \
